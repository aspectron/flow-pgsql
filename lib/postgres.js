...
module.exports = class Postgres {
	...
	constructor(options) {
		...
		let missing = [];
		!options.folder && missing.push('folder');
		...
		//this.folder = path.join(os.homedir(),'.soar');
	...
	start() {
		...
		return new Promise(async (resolve,reject) => {
			...
			// this.folder = path.join(os.homedir(),'.project');
			...
			this.dataFolder = path.join(this.folder, 'pgsql',this.options.database);
